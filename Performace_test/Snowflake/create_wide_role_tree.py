...
def main(repetitions,roles_to_create,measurement_points):
    ...
    try:
        ...
        for i in range(repetitions):
            ...
            for role_num in range(1,roles_to_create+1):
                ...
                for query in sql.generate_role_queries(f"Role{role_num}"):
                    ...
                    if (role_num in measurement_points):
                        qid = cur.sfqid
                ...
                if save:
                    repetition_to_queryid[(i,role_num)] = queries
            # run clean up roles            
        ...
        with open('./benchmark_wide_role_tree_stats.csv', 'w') as file:
    ...
    print("Benchmark results is written to 'benchmark_wide_role_tree_stats.csv'")