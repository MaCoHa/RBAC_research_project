...
experiments = [
    ...
    ("PostgreSQL EC2 wide_tree Create Test", lambda: wide.main(repetitions, time_limit_minutes, file_name="benchmark_wide_tree_postgresql_ec2_Big_stats", db="PostgreSql_EC2")),
